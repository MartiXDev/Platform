...
`MartiX.Platform` package from an isolated local feed and exercises immutable
success, failure, error-category, error-code, and invalid-construction behavior.
