...
using MartiX.FullStackTestApp.Api.Infrastructure.Identity;
...
namespace MartiX.FullStackTestApp.Api.Infrastructure.Host;
...
internal static class HostSecurity
{
        ...
        string reason)
    {
        ...
        return SecurityAuditEvent.Create(
            ...
            action: action,
            outcome: outcome,
            source: "MartiX.FullStackTestApp.Api",
            reason: reason,
            target: target,
...
{
    public const string ActivitySourceName = "MartiX.FullStackTestApp.Api.Host";
    public const string MeterName = "MartiX.FullStackTestApp.Api.Host";
...
{
    public const string TaxonomyName = "MartiX.FullStackTestApp.Host";
