...
using MartiX.FullStackTestApp.Orders.Domain;
...
namespace MartiX.FullStackTestApp.Orders.Features.Status;
...
internal static class OrdersStatusEndpoint
{
    public static void Map(IEndpointRouteBuilder endpoints)
    {
        ...
        group.MapGet(
            ...
            .WithName("MartiX.FullStackTestApp.Orders.Status")
        ...
        permissioned.MapGet(
                "/status/permissioned",
                GetPermissionedStatusAsync)
            .WithName("MartiX.FullStackTestApp.Orders.PermissionedStatus")
