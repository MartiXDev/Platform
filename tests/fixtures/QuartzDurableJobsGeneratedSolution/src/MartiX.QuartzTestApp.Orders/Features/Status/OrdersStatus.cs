...
using MartiX.QuartzTestApp.Orders.Contracts.ModuleContracts;
using MartiX.QuartzTestApp.Orders.Domain;
using MartiX.QuartzTestApp.Orders.Infrastructure.Persistence;
...
namespace MartiX.QuartzTestApp.Orders.Features.Status;
...
internal static class OrdersStatusEndpoint
{
    public static void Map(IEndpointRouteBuilder endpoints)
    {
        ...
        group.MapGet(
            ...
            .WithName("MartiX.QuartzTestApp.Orders.Status")
        ...
        permissioned.MapGet(
                "/status/permissioned",
                GetPermissionedStatusAsync)
            .WithName("MartiX.QuartzTestApp.Orders.PermissionedStatus")
