...
namespace MartiX.QuartzTestApp.Api.Infrastructure.Host;
...
internal static class HostSecurity
{
        ...
        string reason)
    {
        ...
        return SecurityAuditEvent.Create(
            ...
            action: action,
            outcome: outcome,
            source: "MartiX.QuartzTestApp.Api",
            reason: reason,
            target: target,
...
{
    public const string ActivitySourceName = "MartiX.QuartzTestApp.Api.Host";
    public const string MeterName = "MartiX.QuartzTestApp.Api.Host";
...
{
    public const string TaxonomyName = "MartiX.QuartzTestApp.Host";
