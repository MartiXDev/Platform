...
namespace MartiX.TemplateTestApp.Api.Infrastructure.Host;
...
{
    public const string ActivitySourceName = "MartiX.TemplateTestApp.Api.Host";
    public const string MeterName = "MartiX.TemplateTestApp.Api.Host";
...
{
    public const string TaxonomyName = "MartiX.TemplateTestApp.Host";
